...
import { storeToRefs, useAccessStore } from '#/store';

import { useScrollLock } from '#/hooks';
import { useVbenForm, z } from '#/components/FormUi';
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <Avatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <Button class="enter-x w-full" @click="handleSubmit">
