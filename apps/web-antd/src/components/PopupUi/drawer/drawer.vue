...
import { VisuallyHidden } from '#/components/ShadcnComponents';
import {
  Button,
  IconButton,
...
<template>
  ...
  >
    ...
    >
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <HelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </HelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <Loading v-if="showLoading || submitting" spinning />
      <SheetFooter
        v-if="showFooter"
        :class="
          cn(
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || Button"
          ...
          <component
            :is="components.PrimaryButton || Button"
