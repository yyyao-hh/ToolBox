...
import { MoonStar, Sun, SunMoon } from '#/components/Icon';
...
<template>
  <div>
    <Tooltip :disabled="!shouldOnHover" side="bottom">
      <template #trigger>
        <ThemeButton
          :model-value="isDark"
          type="icon"
      ...
      <ToggleGroup
        ...
        variant="outline"
        @update:model-value="
          (val) => preferencesManager.updatePreferences({ theme: { mode: val as ThemeModeType } })
        "
      >
        <ToggleGroupItem
